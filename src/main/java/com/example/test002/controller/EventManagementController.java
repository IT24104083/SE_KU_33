...
public class EventManagementController {
    ...
    // Manage Venue Page with filtering
    ...
    public String manageVenue(@PathVariable("eventId") Integer eventId,
        ...
        try {
            ...
            // Get available venues with filters
            List<Map<String, Object>> availableVenues = eventService.getAvailableVenuesWithFilter(sortOrder, minPrice, maxPrice);
    ...
    // Manage Vendors Page with filtering
    ...
    public String manageVendors(@PathVariable("eventId") Integer eventId,
        ...
        try {
            ...
            List<Map<String, Object>> photographers = eventService.getVendorsByTypeWithFilter("Photographer", sortOrder, minPrice, maxPrice);
            List<Map<String, Object>> caterers = eventService.getVendorsByTypeWithFilter("Caterer", sortOrder, minPrice, maxPrice);
            List<Map<String, Object>> djs = eventService.getVendorsByTypeWithFilter("DJ", sortOrder, minPrice, maxPrice);
            List<Map<String, Object>> decorators = eventService.getVendorsByTypeWithFilter("Decorator", sortOrder, minPrice, maxPrice);
    ...
    // Assign vendor to event for specific service
    ...
    // Remove vendor service from event
